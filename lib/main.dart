...
void main() {
  ...
  //runApp(MaterialApp(home: FullscreenSlider()));
  runApp(CygnusWalls());
}
 ...
 // }
  ...
  //Widget build(BuildContext context) {
   // SystemChrome.setEnabledSystemUIMode(SystemUiMode.immersive);
    ...
    //  systemNavigationBarColor: Color.fromARGB(1, 24, 25, 33), // navigation bar color
    //  statusBarColor: Color.fromARGB(1, 24, 25, 33), // status bar color
    //));
